         ...
         // }
           stage("App Deploy"){
            ...
            {  
               ...
               sh 'ssh  -o StrictHostKeyChecking=no  "cp -r /home/ec2-user/workspace/webapplication/* ubuntu@10.0.2.212:/var/www/html && cd /var/www/html/ && pm2 start index.js -f && NODE_ENV=dev pm2 restart 0 --update-env"'
